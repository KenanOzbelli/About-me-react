...
class Home extends Component{
    ...
    render(){
        ...
        return(
           ...
           <Link to='/about-me'> <h4 className='text-center m-5 slideLeft'> <button className='exploreButton p-3' style={{border:'none',borderRadius:'.3rem', color:'white'}}>Explore My Page</button></h4></Link>
            </>
